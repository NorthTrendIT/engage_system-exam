...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/fetchDueBalances', 'App\Http\Controllers\HomeController@getDueInvoicesAjax')->name('fetchDueBalances')->middleware('check-login');
    ...
    Route::middleware('check-login')->group(function () {
        ...
        Route::middleware('check-access')->group(function () {
            ...
            Route::get('user-update-customers/{number1}/{number2}', 'App\Http\Controllers\UserController@updateUserMultiAccounts')->name('user.update.customers');
            ...
            Route::get('orders/all', 'App\Http\Controllers\OrdersController@allOrders')->name('ssOrders.getAll');
    ...
    Route::get('sap-connection/check/{id}', 'App\Http\Controllers\SapConnectionController@checkAPI')->name('sap-connection.check');
    ...
    Route::prefix('reports')->namespace('App\Http\Controllers\Reports')->name('reports.')->group(function () {
        ...
        Route::get('sales-order-report/count-stat', 'SalesOrderReportController@getCountOrderStat')->name('sales-order-report.count-stat');
        ...
        Route::get('back-order-report/view-details', 'BackOrderReportController@getBackOrderDetails')->name('back-order-report.view-details');
