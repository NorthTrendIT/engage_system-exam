                                                ...
                                                <div class="mt-n1">
                                                    ...
                                                    <div class="m-0">
                                                        ...
                                                        <div class="row g-5 mb-11">
                                                            <div class="col-sm-5">
                                                                <div class="fw-bold fs-7 text-gray-600 mb-1">Customer Name:
                                                                </div>
                                                                <div class="fw-bolder fs-6 text-gray-800">
                                                                    {{ $data->customer->card_name ?? '-' }} (Code:
                                                                    {{ $data->customer->card_code ?? '-' }})</div>
                                                            </div>

                                                            <div class="col-sm-2">
                                                                <div class="fw-bold fs-7 text-gray-600 mb-1">Customer
                                                                    Branch:</div>
                                                                <div class="fw-bolder fs-6 text-gray-800">
                                                                    {{ $data->customer->group->name ?? '-' }}</div>
                                                            </div>

                                                            <div class="col-sm-5">
                                                                <div class="fw-bold fs-7 text-gray-600 mb-1">Delivery
                                                                    Address:</div>
                                                                <div class="fw-bolder fs-6 text-gray-800">
                                                                    {{ $data->address->street ?? '-' }}</div>
                                                            </div>
                                                        </div>

                                                        <div class="row g-5 mb-11">
                                                            <div class="col-sm-5">
                                                                <div class="fw-bold fs-7 text-gray-600 mb-1">Sales
                                                                    Personnel:</div>
                                                                <div class="fw-bolder fs-6 text-gray-800">
                                                                    {{ @$data->sales_specialist->sales_specialist_name ?? '-' }}
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="fw-bold fs-7 text-gray-600 mb-1">Order Date:
                                                                </div>
                                                                <div class="fw-bolder fs-6 text-gray-800">
