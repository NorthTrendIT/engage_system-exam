        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    class="page-title me-3 mb-5 mb-lg-0">
                    <h1 class="text-dark fw-bolder fs-3 my-1 mt-5">
                        @if (isset($edit))
                            Update
                        @else
                            Create
                        @endif Order for Customer
                    </h1>
                </div>
                    ...
                    <form method="post" id="myForm">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                                <div class="form-group">
                                                    <label class="col-form-label text-right">Select Customers<span
                                                            class="asterisk">*</span></label>
                                                    <select class="form-select " id='selectCustomers' data-control="select2"
                                                        data-hide-search="false" name="customer_id"
                                                        @if (isset($edit)) disabled="disabled" @endif>
                                                        @if (isset($edit))
                                                            <option value="{{ $edit->customer_id }}" selected>
                                                                {{ $edit->customer->card_name }}</option>
                                                        @else
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                                <div class="form-group">
                                                    <label class="col-form-label text-right">Select Address<span
                                                            class="asterisk">*</span></label>
                                                    <select class="form-select selectAddress" id='selectAddress'
                                                        data-control="select2" data-hide-search="false" name="address_id"
                                                        @if (!isset($edit)) disabled="disabled" @endif>
                                                        ...
                                                        @if (isset($edit))
                                                            ...
                                                            @endphp
                                                            <option value="{{ $edit->address->id }}" selected>
                                                                {{ $address }}</option>
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                                <label class="col-form-label text-right">Delivery Date<span
                                                        class="asterisk">*</span></label>
                                                <input type="text" class="form-control" placeholder="Delivery Date"
                                                    id="kt_datepicker_1" name="due_date" autocomplete="off"
                                                    @if (isset($edit)) value="{{ date('m/d/Y', strtotime($edit->due_date)) }}" @endif>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="row g-xl-8">
                                <div class="col-xl-12">
                                    <div class="card card-xl-stretch mb-5 mb-xl-8 stickyHeaderTbl" id="productFormTbl">

                                        <div
                                            class="card-header border-0 pt-2 pb-2 bg-dark d-flex justify-content-between align-items-center stickyContentTbl">
                                            <h3 class="card-title align-items-start flex-column mb-0">
                                                <span class="card-label fw-bolder fs-3 text-white">Products</span>
                                            </h3>
                                            <input type="button" class="btn btn-sm btn-primary mr-2 therepeat2"
                                                data-repeater-create value="Add Product">
                                        </div>
                                                    ...
                                                    <tbody data-repeater-list="products">
                                                        ...
                                                        @if (isset($edit) && $edit->items->where('type', 'product')->count() > 0)
                                                            ...
                                                            @foreach ($edit->items->where('type', 'product') as $value)
                                                                @php
                                                                    if (
                                                                        $value->product->sap_connection_id ===
                                                                        $edit->customer->real_sap_connection_id
                                                                    ) {
                                                                        $currency_symbol = get_product_customer_currency(
                                                                            @$value->product->item_prices,
                                                                            $edit->customer->price_list_num,
                                                                        );
                                                                    }
                                                                @endphp
                                                                <tr data-repeater-item name="items">
                                                                    <td>{{ $pCounter }}</td>
                                                                    <td>
                                                                        <select class="form-select selectProducts"
                                                                            data-control="select2" data-hide-search="false"
                                                                            name="product_id">
                                                                            <option value="{{ $value->product->id }}"
                                                                                selected>{{ $value->product->item_name }}
                                                                    ...
                                                                    <td style="text-align:right" class="">
                                                                        <div class="d-flex justify-content-end">
                                                                            <span
                                                                                class="price text-primary mb-0">{{ $currency_symbol . '' . number_format_value(@$value->price) }}</span>
                                                                        </div>
                                                                    </td>
                                                                    <td class="text-center">
                                                                        {{ $value->product->group->group_name }}</td>
                                                                    <td class="text-center">
                                                                        {{ $value->product->sap_connection->company_name }}
                                                                    </td>
                                                                    <td style="text-align:right" class="">
                                                                        <div class="d-flex justify-content-end">
                                                                            <span class="amount text-primary"
                                                                                style="font-weight: bold">{{ number_format_value(@$value->total) }}</span>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <input type="button"
                                                        ...
                                                        @else
                                                            <tr data-repeater-item name="items">
                                                                ...
                                                                <td>
                                                                    <div class="form-group">
                                                                        <select class="form-select  selectProducts"
                                                                            ...
                                                                            data-hide-search="false" name="product_id">
                                                                ...
                                                                <td>
                                                                    <input type="number"
                                                                        class="form-control text-center quantity"
                                                                        name="quantity" data-price="0"
                                                                        placeholder="Enter quantity" value=""
                                                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                                                </td>
                                                                <td style="text-align:right" class="">
                                                                    <div class="d-flex justify-content-end">
                                                                        <span class="price text-primary mb-0 d-flex">₱
                                                                            0</span>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td style="text-align:right" class="">
                                                                    <div class="d-flex justify-content-end">
                                                                        <span class="amount price text-primary mb-0 d-flex"
                            ...
                            <div class="row g-xl-8">
                                <div class="col-xl-12">
                                    <div class="card card-xl-stretch mb-5 mb-xl-8 stickyHeaderTbl" id="promoFormTbl">

                                        <div
                                            class="card-header border-0 pt-2 pb-2 bg-dark d-flex justify-content-between align-items-center stickyContentTbl">
                                            <h3 class="card-title align-items-start flex-column mb-0">
                                                <span class="card-label fw-bolder fs-3 text-white">Promo / Marketing
                                                    Items</span>
                                            </h3>
                                            <input type="button" class="btn btn-sm btn-primary mr-2 therepeat"
                                                data-repeater-create value="Add Promo / Marketing Items">
                                        </div>
                                                ...
                                                <table
                                                    ...
                                                    <thead>
                                                        <tr class="fw-bolder">
                                                            ...
                                                            <th class="min-w-200px">Product</th>
                                                            <th class="min-w-80px text-center">Quantity</th>
                                                            <th class="min-w-80px d-none" style="text-align:right">Price
                                                            </th>
                                                            <th class="min-w-100px text-center">Item Group</th>
                                                            <th class="min-w-80px text-center">DB</th>
                                                            <th class="min-w-80px d-none" style="text-align:right">Amount
                                                            </th>
                        ...
                        <div class="d-flex flex-wrap justify-content-between remark_div">
                                ...
                                <div class="align-items-sm-center mb-7">
                                    <div class="">
                                        <div class="flex-grow-1 me-2">
                                            ...
                                            <textarea type="text" class="form-control" placeholder="Remark" id="remark" name="remark"
                                                autocomplete="off" rows="5">{{ @$edit->remarks }}</textarea>
                                        </div>
                            ...
                            <div class="col-xl-4">
                                ...
                                <div class="flex-grow-1">
                                    <p class="custom_note">Note: Final amount of order will reflect <br>on the actual
                                        invoice.</p>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="sub-total-box">
                                            <div class="row d-none">
                                                <div class="col-md-6 mb-3">
                                                    <span class="text-muted me-2 fs-7 fw-bold text-uppercase">sub
                                                        total</span>
                                                </div>
                                                <div class="col-md-6 mb-3 ">
                                                    <span style="text-align: right; width: 100%;"
                                                        class="d-block text-primary price subTotal">
                                                        @if (isset($edit))
                                                            ₱ {{ $edit->total }}
                                                        @else
                                                            ₱ 0.00
                                                ...
                                                <div class="col-md-6 mb-3 d-none">
                                                    <span
                                                        class="text-muted me-2 fs-7 fw-bold text-uppercase">discount</span>
                                                </div>
                                                <div class="col-md-6 mb-3 d-none">
                                                    <span style="text-align: right; width: 100%;"
                                            ...
                                            <div class="row pt-8" style="border-top: 1px solid #e4e6ef;">
                                                ...
                                                <div class="col-md-6 mb-3 d-inline">
                                                    <input type="hidden" name="total_amount"
                                                        @if (isset($edit)) value="{{ $edit->total }}" @else value="0" @endif>
                                                    <span style="text-align: right; width: 100%;"
                                                        class="text-primary price grandTotal">
                                                        @if (isset($edit))
                                                            {{ $edit->total }}
                                                        @else
                                                            ₱ 0.00
                        ...
                        <div class="row gy-5 g-xl-8">
                            ...
                            <div class="col-xl-12">
                                <div class="d-flex flex-wrap pt-2 text-center justify-content-center">
                                    <span><b>Note:
                                            Place Order for Approval - will require customer's account approval prior to
                                            being pushed into the SAP system.<br>

                                            Place Order - it will be directly pushed to the SAP system without requesting
                                            approval from the customer's account.
                                        </b></span>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.therepeat2').on('click', function() {
                ...
                scrollToBottom('productFormTbl');
            });

            $('.therepeat').on('click', function() {
                addTblIndex('#promoFormTbl');
                scrollToBottom('promoFormTbl');
            })
                                ...
                                if ($dates.length > 0) {
                                    $('[name="due_date"]').datepicker({
                                        ...
                                        beforeShowDay: function(date) {
                                            if ($dates.indexOf(formatDate(date)) <
                                                0)
                                                return {
                                                    enabled: false
                                                }
                ...
                var validator = $("#myForm").validate({
                    ...
                    errorPlacement: function(error, element) {
                        ...
                        if ($(element[0]).hasClass('select2-hidden-accessible')) {
                            $(error).insertAfter(element.next().find('.select2-selection--single')
                                .addClass('is-invalid'));
                        } else {
            ...
            $(document).on('change', '.selectProducts', function(event) {
                ...
                if ($customer_id) {
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.status) {
                                $self.parent().parent().parent().find('.price').html(data
                                    .currency_symbol + ' ' + number_format(data.price));
                                $self.parent().parent().parent().find('.quantity').attr(
                                    'data-price', data.price);
                                $self.parent().parent().parent().find('.quantity').attr(
                                    'data-currency', data.currency_symbol);
                                $qty = parseFloat($self.parent().parent().parent().find(
                                    ".quantity").val());
                                if (isNaN($qty)) {
                                    $self.parent().parent().parent().find(".quantity").val(1)
                                        .trigger('change');
                                } else {
                                    $self.parent().parent().parent().find(".quantity").trigger(
                                        'change');
                                }
                            } else {
                                toast_error(data.message);
            ...
            $(document).on('change', "input[type=number]", function(event) {
                ...
                $(this).parent().parent().find('td .amount').html($currency + '' + number_format($amount
                    .toFixed(2)));
        ...
        function scrollToBottom(divEl) {
            const el = document.getElementById(divEl);
            setTimeout(function() {
                el.scrollTo({
                    top: el.scrollHeight,
                    behavior: "smooth"
