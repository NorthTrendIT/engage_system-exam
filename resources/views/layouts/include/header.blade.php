                  ...
                  <div class="cursor-pointer btn btn-icon btn-clean btn-lg mr-1">
                        <a href="{{ route('cart.index') }}" class="btn btn-icon btn-clean btn-lg mr-1">
                            <span class="svg-icon svg-icon-xl svg-icon-primary">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" style="height: 30px !important; width: 30px !important;">
