...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
   ...
   <div class="aside-logo flex-column-auto" id="kt_aside_logo">
      ...
      <span class="text-white logo" style="font-size: 20px;">Engage System</span>
      </a>
      <!--end::Logo-->
      <!--begin::Aside toggler-->
   ...
   <div class="aside-menu flex-column-fluid">
      ...
      <div class="hover-scroll-overlay-y my-5 my-lg-5 sidebar-box" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0" style="height: 185px;">
         ...
         <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
            ...
            {{-- Product List --}}
            @if((isset($access['view-product-list']) && $access['view-product-list'] == 1 && Auth::user()->role_id == 4))
            <div class="menu-item">
            ...
            @if(userrole() == 14 || (isset($access['view-all-customer-delivery-schedule']) && $access['view-all-customer-delivery-schedule'] == 1))
            <div class="menu-item">
               <a class="menu-link {{ (in_array(request()->route()->getName(), ['customer-delivery-schedule.ss-view', 'customer-delivery-schedule.all-view'])) ? 'active' : '' }}" @if(userrole() == 14) href="{{ route('customer-delivery-schedule.ss-view') }}" @else href="{{ route('customer-delivery-schedule.all-view') }}" @endif>
                  <span class="menu-icon">
                     <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                     <span class="svg-icon svg-icon-2">
