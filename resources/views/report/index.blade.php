                    ...
                    <div class="card-p">
                        <div class="row">
                            ...
                            <div class="col-md-3 bg-light-primary px-6 py-8 rounded-2 me-7 mb-7 min-w-150">
                                ...
                                <a href="{{ route('reports.product-report.index') }}" class="text-primary fw-bold fs-6">Product Report </a>
                            </div>
                            ...
                            <div class="col-md-3 bg-light-success px-6 py-8 rounded-2 me-7 mb-7 min-w-150">
                                ...
                                <a href="{{ route('reports.credit-memo-report.index') }}" class="text-success fw-bold fs-6">Credit Memo Report </a>
                            </div>
                            ...
                            <div class="col-md-3 bg-light-dark px-6 py-8 rounded-2 me-7 mb-7 min-w-150">
                                ...
                                <a href="{{ route('reports.debit-memo-report.index') }}" class="text-dark fw-bold fs-6">Debit Memo Report </a>
                            </div>
                            ...
                            <div class="col-md-3 bg-light-danger px-6 py-8 rounded-2 me-7 mb-7 min-w-150">
                                ...
                                <a href="{{ route('reports.return-order-report.index') }}" class="text-danger fw-bold fs-6">Return Order Report </a>
                            </div>
                        </div>
                    </div>
                </div>
