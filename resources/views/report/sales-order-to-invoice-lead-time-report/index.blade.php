...
@section('title','Sales Order To Invoice Lead Time Report')
  ...
  <div class="toolbar" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
      <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title me-3 mb-5 mb-lg-0">
        <h1 class="text-dark fw-bolder fs-3 my-1 mt-5">Sales Order To Invoice Lead Time Report</h1>
      </div>
...
<script>
  $(document).ready(function() {
    ...
    function render_table(jsonData){
      ...
      table.DataTable({
        ...
        columns: [
            ...
            {data: 'order_date', name: 'doc_total' ,orderable:false,searchable:false},
            {data: 'order_doc_num', name: 'item_description' ,orderable:false,searchable:false},
            ...
            {data: 'lead_time', name: 'price_after_vat' ,orderable:false,searchable:false},
        ],
    ...
    $(document).on("click", ".download_excel", function(e) {
      var url = "{{route('reports.sales-order-to-invoice-lead-time-report.export')}}";
