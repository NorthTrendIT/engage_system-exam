...
<body style="max-width: 100%; margin: 0 auto;padding:0;">
	...
	<table class="transcript-tbl" width=" 100%" border="0" cellpadding="0" cellspacing="0" style="background: #fdfdfd; padding: 20px 0; border-radius: 7px; border: 1px solid #cfcfcf;margin-top: 0px;width: 100%;page-break-before: always;">
		<tbody>
		<tr style="width: 100%;">
